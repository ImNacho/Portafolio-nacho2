...
export default function Footer({ subPage = false }: { subPage?: boolean }) {
  ...
  const socials = [
    { name: "GitHub", icon: Github, href: "https://github.com/ImNacho" },
    { name: "LinkedIn", icon: Linkedin, href: "https://www.linkedin.com/in/hernan-jos%C3%A9-mendoza-ib%C3%A1%C3%B1ez-229332212/" },
    { name: "X", icon: XLogo, href: "https://x.com/yonachox" },
    { name: "Instagram", icon: Mail, href: "https://www.instagram.com/soynachooo/" },
  ...
  return (
    <>
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-3xl h-[300px] pointer-events-none flex justify-center opacity-20">
        <div className="absolute -top-[150px] w-[600px] h-[300px] rounded-[100%] bg-gradient-to-b from-red-500/40 via-orange-500/25 to-transparent blur-3xl" />
      </div>
      ...
      <div className="px-6 md:px-10 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-6 md:gap-x-10 gap-y-10 md:gap-y-8 mb-8 md:mb-10 xl:grid-cols-4 xl:gap-x-10">
          <div className="space-y-4 lg:col-span-1">
            <div className="flex items-center gap-2">
              <img src="/logon.png" alt="Hernán Mendoza" className="h-10 w-10 rounded-xl object-cover" />
              <span className="font-mono text-xl font-bold whitespace-nowrap">
                Hernán<span className="text-primary"> Mendoza</span>
              </span>
            </div>
        ...
        <div className="pt-6 border-t border-border/10 flex flex-col md:flex-row items-center justify-between gap-3 text-xs text-muted-foreground">
          <div className="flex items-center gap-1.5">
            © {year || "2026"} Designed & Developed by Hernán Mendoza.
          </div>
