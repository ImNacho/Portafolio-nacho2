          ...
          <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 items-start">
            ...
            <div className="flex flex-col items-center gap-6 order-first md:order-last reveal">
              <div className="relative">
                <div className="absolute inset-0 rounded-full bg-orange-500/10 blur-3xl scale-[3] pointer-events-none" />
                <div className="absolute inset-0 rounded-full bg-red-400/8 blur-[80px] scale-[4] pointer-events-none" />
                <div className="group relative w-56 h-56 rounded-full flex items-center justify-center overflow-hidden ring-1 ring-red-400/20 ring-offset-4 ring-offset-background shadow-[0_0_80px_20px_rgba(99,102,241,0.06)]">
                  <img
                    src="/profile.jpg"
                    alt="Hernán Mendoza"
                    loading="lazy"
                ...
                <div className="absolute -bottom-2 -right-2 glass rounded-2xl p-3 border-border/50 shadow-xl animate-float">
                  <div className="flex items-center gap-2 text-xs">
                    ...
                    <span className="text-foreground font-medium">Montería, Colombia 🇨🇴</span>
                  </div>
                </div>
                <div className="absolute -top-2 -right-4 glass rounded-2xl p-3 border-border/50 shadow-xl animate-float anim-delay-1">
                  <div className="flex items-center gap-2 text-xs">
                    ...
                    <span className="text-foreground font-medium">Ingeniero de Sistemas & Full Stack</span>
                  </div>
                </div>
              </div>

              <div className="grid grid-cols-5 md:grid-cols-3 lg:grid-cols-5 gap-2.5 w-full">
                <button
                  onClick={() => setContactOpen(true)}
                  title="Contactar"
                  className="glass hover:bg-foreground/5 text-muted-foreground hover:text-foreground h-10 rounded-2xl md:rounded-xl flex items-center justify-center transition-all duration-300 border border-border/50 hover:border-foreground/30 cursor-pointer"
                >
                ...
                <a
                  ...
                  className="glass hover:bg-foreground/5 text-muted-foreground hover:text-foreground h-10 rounded-2xl md:rounded-xl flex items-center justify-center gap-1 transition-all duration-300 border border-border/50 hover:border-foreground/30 cursor-pointer"
                >
                ...
                <a href="https://www.linkedin.com/in/hernan-josé-mendoza-ibáñez-229332212/" target="_blank" rel="noopener noreferrer"
                  title="LinkedIn" aria-label="LinkedIn"
                  className="glass hover:bg-foreground/5 text-muted-foreground hover:text-foreground h-10 rounded-2xl md:rounded-xl flex items-center justify-center transition-all duration-300 border border-border/50 hover:border-foreground/30 cursor-pointer">
                  <Linkedin className="w-4 h-4" />
                </a>
                <a href="https://github.com/ImNacho" target="_blank" rel="noopener noreferrer"
