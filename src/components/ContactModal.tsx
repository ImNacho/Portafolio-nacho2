          ...
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="flex items-center gap-3 pt-1">
                <a href="mailto:andromixm@gmail.com" className="flex items-center gap-1.5 text-xs text-muted-foreground hover:text-foreground transition-colors">
                  <Mail className="w-3.5 h-3.5" /> Email
                </a>
                <span className="text-foreground/20">·</span>
                <a href="https://www.linkedin.com/in/hernan-josé-mendoza-ibáñez-229332212/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 text-xs text-muted-foreground hover:text-foreground transition-colors">
                  <Linkedin className="w-3.5 h-3.5" /> LinkedIn
                </a>
                <span className="text-foreground/20">·</span>
                <a href="https://github.com/ImNacho" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 text-xs text-muted-foreground hover:text-foreground transition-colors">
